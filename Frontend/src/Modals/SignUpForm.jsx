            ...
            <Form>
              ...
              <Form.Group className="mb-3">
                ...
                {seeRetype ? (
                  <Row>
                    <Col sm={10}>
                      <Form.Control type="text" placeholder="Password" name="retype" onChange={handleChange}/>
                    </Col>
                    <Col sm={2}>
                  ...
                  <Row>
                    <Col sm={10}>
                      <Form.Control type="password" placeholder="Password" name="retype" onChange={handleChange}/>
                    </Col>
                    <Col sm={2}>
